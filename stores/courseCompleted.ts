...
type CourseCompletedState = PaginateState & LoadingState;
...
export const useCourseCompletedStore = defineStore("courseCompleted", {
  state: () =>
    courseAdapter.getInitialState<CourseCompletedState>({
      count: 0,
      next: null,
      previous: null,
      state: "idle",
