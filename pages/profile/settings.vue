...
<template>
    <div class="fixed inset-0 flex justify-right bg-[rgba(0,0,0,0.5)] z-10">
        <div class="flex-1 flex flex-col space-y-4 bg-white" md="flex-none w-md">
            ...
            <section class="flex flex-col space-y-4 px-4">
