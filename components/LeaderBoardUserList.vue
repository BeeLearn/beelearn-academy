...
<template>
  <section 
		...
		<div v-for="userLeague, index in userLeagues">
			<div class="flex space-x-6 items-center p-3">
				...
				<div class="flex-1 flex space-x-4 items-center">
					<img 
						...
						class="w-8 h-8" />
					<h1 class="text-base font-medium">{{  userLeague.user.full_name }}</h1>
				</div>
				<p class="text-sm text-stone-500">{{ userLeague.xp }} XP</p>
			</div>
			<div 
				v-if="index > count * 0.7" 
